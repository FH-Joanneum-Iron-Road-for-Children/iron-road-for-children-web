...
export class EventInfoService {
  ...
  getEventInfoById(id: number): Observable<EventInfoDto> {
    return this.httpClient.get<EventInfoDto>(`api/eventInfos/${id}`);
  }
  ...
  deleteEventInfoById(id: number) {
    return this.httpClient.delete<Response>(`api/eventInfos/${id}`);
  }
}
